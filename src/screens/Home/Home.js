...
class Home extends Component {
  static navigationOptions = ({ navigation }) => ({
    ...
    // headerRight: (
    //   <TouchableOpacity
    //     onPress={() => navigation.navigate('ProductListView')}
    //   >
    //     <Image
  ...
  storeBannerItemClicked = item => {
    this.props.navigation.navigate('ProductListView', { Store: item, type: item.type });
  };
  ...
  bannerAction = item => {
    switch (item.object_type) {
      ...
      case 'store':
        ...
        this.props.navigation.navigate('ProductListView', { Store: itemInfo, type: itemInfo.type });
        break;
      case 'product':
        this.props.navigation.navigate('HomeProductDetail', {
  ...
  renderSearchView() {
    return (
      <TouchableOpacity
        ...
        onPress={() => this.props.navigation.navigate('ProductListView', { type: productListViewTypes.search })}
      >
        <Image
          style={{
            marginHorizontal: 10,
